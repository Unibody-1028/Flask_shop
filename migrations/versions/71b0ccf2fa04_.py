...
Revision ID: 71b0ccf2fa04
Revises: 8da13080e202
Create Date: 2025-09-26 22:07:45.058962
...
revision = '71b0ccf2fa04'
down_revision = '8da13080e202'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('fapiao_content', sa.String(length=512), nullable=True),
    sa.Column('addrs', sa.String(length=512), nullable=True),
